...
bool GetStartOnSystemStartup()
{
    ...
    if (fujicoinAppUrl == nullptr) {
        return false;
    }

    LSSharedFileListRef loginItems = LSSharedFileListCreate(nullptr, kLSSharedFileListSessionLoginItems, nullptr);
    CFArrayRef listSnapshot = LSSharedFileListCopySnapshot(loginItems, nullptr);
    bool res = (findStartupItemInList(listSnapshot, loginItems, fujicoinAppUrl) != nullptr);
    CFRelease(fujicoinAppUrl);
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    LSSharedFileListRef loginItems = LSSharedFileListCreate(nullptr, kLSSharedFileListSessionLoginItems, nullptr);
    CFArrayRef listSnapshot = LSSharedFileListCopySnapshot(loginItems, nullptr);
    LSSharedFileListItemRef foundItem = findStartupItemInList(listSnapshot, loginItems, fujicoinAppUrl);
