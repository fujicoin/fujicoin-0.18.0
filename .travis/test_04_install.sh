...
git clone https://github.com/fujicoin-core/qa-assets ${DIR_FUZZ_IN}
...
env | grep -E '^(FUJICOIN_CONFIG|CCACHE_|WINEDEBUG|LC_ALL|BOOST_TEST_RANDOM|CONFIG_SHELL|(ASAN|LSAN|TSAN|UBSAN)_OPTIONS)' | tee /tmp/env
